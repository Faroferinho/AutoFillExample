...
public class SuggestionLabel extends JLabel {
	...
	private static final long serialVersionUID = -4885814266952467940L;
	
	private final Suggestor auto;
	...
	public SuggestionLabel(String text, Color borderColor, Color textColor, Suggestor suggestor) {
		super(text);
